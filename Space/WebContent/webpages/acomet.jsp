...
<script src="<c:url value="resources/Scripts/acomet.js"/>"></script>
<script
	...
	<div ng-app="myApp" ng-controller="myCtrl">
		...
		<div ng-hide="noData">
				...
				<div class="col-xs-12 col-md-6 ">
					<ul>
					<li>Name of Comet :<i ng-bind="cometData.target.name"></i></li>
					<li>To view more about this comet:Click---><a
						href="{{cometData.service.href}}">here</a></li>
					<li>Coordinates Reference Frame (coordsys): <i
						ng-bind="cometData.coordsys"></i>
					</li>
					<li><details close> <summary>Equinox : <i
							ng-bind="cometData.equinox"> </i></summary>
						...
						<p>In astronomy, equinox is a moment in time at which the
							...
							system. The position at other equinoxes can be computed by taking
							into account precession, nutation and aberration, which directly
							affect e.g. right ascension and declination.</p>
					...
					<li><details close> <summary> Right
						Ascension:- decimal:<i ng-bind="cometData.ra.decimal"></i>, h:<i
							ng-bind="cometData.ra.h"></i>,m:<i ng-bind="cometData.ra.m"></i>
						s:<i ng-bind="cometData.ra.s"></i> </summary> Right ascension (abbreviated
						RA) is the angular distance measured eastward along the celestial
						equator from the vernal equinox to the hour circle of the point in
						question. </details></li>
					<li><details close> <summary>
						Declination:- decimal:<i ng-bind="cometData.dec.decimal"></i>, h:<i
							ng-bind="cometData.dec.h"></i>,m:<i ng-bind="cometData.dec.m"></i>
						s:<i ng-bind="cometData.dec.s"></i> </summary> In astronomy, declination
					...
					<li>Location in Galactic Coordinates :- lon :<i
						ng-bind="cometData.galactic.lon"></i>, lat :<i
						ng-bind="cometData.galactic.lat"></i>
					</li>
					<li><details close> <summary> Julian Day :<i
							ng-bind="cometData.jd"></i> </summary> Julian day is the continuous count
						of days since the beginning of the Julian Period used primarily by
						astronomers. </details></li>
					<li>To know more on the comet: <a
						href="{{cometData.image.href}}"><i
							ng-bind="cometData.image.href"></i></a></li>
					</ul>
				</div>
				<div class="col-xs-6 col-md-6">
					<img src="{{cometData.image.src}}" id="imgFrmJsonData">
				</div>
			</div>
			</div>
